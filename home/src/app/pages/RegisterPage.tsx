  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 py-12 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 left-16 w-16 h-16 pointer-events-none hidden xl:block"
      >
        <motion.img
          animate={{ 
            y: [0, -20, 0],
      ...
      <motion.div
        ...
        className="absolute top-1/3 right-12 w-20 h-20 pointer-events-none hidden xl:block"
      >
        <motion.img
          animate={{ 
            y: [0, 15, 0],
      ...
      <motion.div
        ...
        className="absolute bottom-32 left-20 w-24 h-24 pointer-events-none hidden xl:block"
      >
        <motion.img
          animate={{ 
            y: [0, -15, 0],
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] pointer-events-none hidden lg:block"
      >
        <motion.img
          animate={{ 
            scale: [1, 1.05, 1],
